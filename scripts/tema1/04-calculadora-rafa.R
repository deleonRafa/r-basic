...
pi + sqrt(2)i #esto dará error)
complex(real = pi, imaginary = sqrt(2))->z1 #esta es la fomra correcta
z1
...
#la raíz cuadrada devuelve, de las soluciones la de 
#Re(z)>0, para obtener la otra, hay que multiplicar por -1
sqrt(3+2i) # igual a z^2 = 3 + 2i
sqrt(3+2i)*-1 # igual a z^2 = 3 - 2i
exp(3+2i) 
sin(3+2i)
cos(3+2i)
...
#Es igual a arcos(Re(z)/Mod(z))
#y también igual a arcsin(Im(z)/Mod(z))
#argumento va de (-pi, pi)
